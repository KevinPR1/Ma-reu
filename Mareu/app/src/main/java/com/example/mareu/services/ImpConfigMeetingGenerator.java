...
public class ImpConfigMeetingGenerator {
    ...
    public static List<Meeting> MEETING_LIST = Arrays.asList(
            ...
            new Meeting("15h00", MEETING_ROOMS_LIST.get(8).getName(), "Réunion D", MEMBER_LIST.get(8).getMail() + ", " + MEMBER_LIST.get(9).getMail() + ", " + MEMBER_LIST.get(6).getMail(), "18/12/2019", MEETING_ROOMS_LIST.get(8).getImage())
    );
