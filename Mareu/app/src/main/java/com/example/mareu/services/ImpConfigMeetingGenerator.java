...
public class ImpConfigMeetingGenerator {
    ...
    public static List<Meeting> MEETING_LIST = Arrays.asList(
            ...
            new Meeting("15h00", MEETING_ROOMS_LIST.get(2).getName(), "Réunion C", MEMBER_LIST.get(5).getMail() + MEMBER_LIST.get(4).getMail() + MEMBER_LIST.get(3).getMail(), "28/11/2019", MEETING_ROOMS_LIST.get(2).getImage())
    );
